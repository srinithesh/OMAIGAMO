...
import { UploadIcon, CameraIcon, BoltIcon, PlayIcon } from './Icons';
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 animate-fade-in">
      <div className="w-full max-w-5xl text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-pine/50 border-2 border-bangladesh-green rounded-lg p-8 flex flex-col items-center justify-between transition-all duration-300 hover:border-caribbean-green hover:shadow-glow-green transform hover:-translate-y-1">
            ...
            <div className="w-full space-y-4">
               <div 
                  ...
                  className="bg-rich-black/30 border-2 border-dashed border-bangladesh-green/70 rounded-md p-4 w-full cursor-pointer hover:border-caribbean-green/70"
                >
                  <p className="font-semibold text-anti-flash-white/90">CCTV Feed</p>
                  <p className="text-sm text-stone">{videoFile ? videoFile.name : 'Select .mp4 file'}</p>
                ...
                <div 
                  ...
                  className="bg-rich-black/30 border-2 border-dashed border-bangladesh-green/70 rounded-md p-4 w-full cursor-pointer hover:border-caribbean-green/70"
                >
                  <p className="font-semibold text-anti-flash-white/90">Transaction Log</p>
                  <p className="text-sm text-stone">{transactionLog ? 'Log file loaded' : 'Select .csv file'}</p>
            ...
            <div className="w-full mt-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button
                      ...
                      className="w-full sm:w-auto text-lg font-bold bg-caribbean-green text-rich-black px-8 py-3 rounded-md hover:bg-mountain-meadow hover:shadow-glow-green-lg transition-all duration-300 disabled:bg-stone disabled:cursor-not-allowed flex items-center justify-center gap-3"
                    >
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full sm:w-auto text-lg font-bold bg-transparent border-2 border-frog text-frog px-8 py-3 rounded-md hover:bg-frog hover:text-rich-black transition-all duration-300 disabled:opacity-50"
                    >
                        Use Mock Data
                    </button>
                </div>
          ...
          <div className="bg-pine/50 border-2 border-bangladesh-green rounded-lg p-8 flex flex-col items-center justify-center text-center transition-all duration-300 hover:border-caribbean-green hover:shadow-glow-green transform hover:-translate-y-1">
